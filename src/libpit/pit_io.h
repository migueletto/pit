...
typedef int (*io_callback_f)(int event, io_addr_t *peer, unsigned char *buf, int len, int fd,
                             int handle, void **data);

typedef int (*io_custom_f)(int fd, void *data);
...
int io_stream_bound_client(char *tag, io_addr_t *src, io_addr_t *addr, io_callback_f callback,
                           void *data, int timeout, bt_provider_t *bt);

int
io_stream_client(char *tag, io_addr_t *addr, io_callback_f callback, io_custom_f custom, void *data,
                 int timeout, bt_provider_t *bt);

int
io_stream_server(char *tag, io_addr_t *addr, io_callback_f callback, io_custom_f custom, void *data,
                 int timer, bt_provider_t *bt);
...
int
io_dgram_server(char *tag, io_addr_t *addr, io_callback_f callback, void *data, bt_provider_t *bt);
